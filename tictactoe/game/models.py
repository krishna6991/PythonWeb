...
class Game(models.Model):
    ...
    def board(self):
        """return a 2-dimensional list of Move objects, so you can ask for the state
    ...
    def update_after_move(self,move):
        """Update the status of the game, given the last same"""
    ...
    def new_move(self):
        """Returns a new move object with player, game, count and preset"""
